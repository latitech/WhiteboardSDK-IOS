...
#import "WBRoom.h"
#import "WBRoomMember.h"
#import "WBBoardInfo.h"
#import "WBActiveWidgetInfo.h"
#import "WBWidgetActionEvent.h"
...
-(void)onScreenDirty;
  ...
  */
@optional
-(void) onBoardStatusChanged:(WBBoardStatus)status;
...
-(void) onUserList:(NSArray *)users;
  ...
  */
@optional
-(void) onUserJoin:(WBRoomMember *)user;
 /**
  * 有其它用户离开了房间
  *
  * @param user 用户信息
  */
@optional
-(void) onUserLeave:(WBRoomMember *)user;
...
-(void) onBoardPageList:(NSArray *)list;
  ...
  */
@optional
-(void)onCurrentBoardPageChanged:(WBPageInfo *)page_;
  ...
  */
@optional
-(void)onBoardPageInfoChanged:(WBPageInfo *)page_;
  ...
  */
@optional
-(void)onBoardSizeChanged:(WBBoardInfo*)info_;
  ...
  */
@optional
-(void)onBoardScroll:(WBBoardInfo*)info_;
...
-(void)onBackgroundColorChanged:(NSString *)backgroundColor;
  ...
  */
@optional
-(void)onWidgetActive:(WBActiveWidgetInfo * _Nullable)info;
  ...
  */
@optional
-(void)onFilePageChanged:(WBActiveWidgetInfo *)info;
  ...
  */
@optional
-(void)onWidgetActionEvent:(WBWidgetActionEvent *)event;
